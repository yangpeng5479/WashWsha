...
*/
    ...
    //AppID
    #define MOBSSDKFacebookAppID @"2035736709999461"
    //AppSecret
    #define MOBSSDKFacebookAppSecret @"9105b222f2499df67a900a23b9e5cf0d"
    //displayName facebook客户端分享必须
    #define MOBSSDKFacebookDisplayName @"Vcoze"
    //AuthType 授权优先类型 web sso both
 ...
 */
    ...
    //ClientID
    #define MOBSSDKInstagramClientID @"e7b56aa05493455a8be1b7a9a2687c98"
    //ClientSecret
    #define MOBSSDKInstagramClientSecret @"7265dfa77b4b40a2b8d07fd7575a318d"
    //redirectUri
    #define MOBSSDKInstagramRedirectUri @"http://mob.com"
#endif
 ...
 */
    ...
    //ConsumerKey
    #define MOBSSDKTwitterConsumerKey @"xUQZvfDp19WzzTUFA8P4o0YD2"
    //ConsumerSecret
    #define MOBSSDKTwitterConsumerSecret @"4yBkcIDxg2kzK1xzICWPETLHo8sG4y5eNZHxHVlH8VHIHYgb7L"
    //RedirectUri
...
*/
    ...
    //ClientID
    #define MOBSSDKGooglePlusClientID @"526792811077-ogs37u9u5dh48rf98kn820j1406jba8p.apps.googleusercontent.com"
    //ClientSecret
