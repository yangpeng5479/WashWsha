...
@implementation WealthTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        cell.wealthModel = self.dataArr[indexPath.row];
        return cell;
        ...
        BaseFindTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"wealth"];
        if (!cell) {
            
            cell = [[BaseFindTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"wealth"];
